...
const DefenceFooter = () => {
  return (
    <footer className="bg-defence-dark text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">DEFENCE REALTOR</span>
            </div>
            <p className="text-gray-300 leading-relaxed">
              106, Green Lotus Ave, Singhpura Chowk, Zirakpur, Punjab - 760603
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-gray-700 rounded flex items-center justify-center hover:bg-defence-green transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <a href="#mission" className="block text-gray-300 hover:text-white transition-colors">Mission</a>
              <a href="#projects" className="block text-gray-300 hover:text-white transition-colors">Projects</a>
              <a href="#services" className="block text-gray-300 hover:text-white transition-colors">Services and News</a>
            </div>
          </div>

          {/* Right Column - More Navigation Links */}
          <div className="space-y-4">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm">
            Copyright © 2024 All rights reserved. Luxury Interior.
          </p>
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="#" className="text-gray-300 hover:text-white text-sm transition-colors">Terms & Conditions</a>
            <span className="text-gray-500">|</span>
            <a href="#" className="text-gray-300 hover:text-white text-sm transition-colors">Privacy Policies</a>
          </div>
        </div>
      </div>
    </footer>
